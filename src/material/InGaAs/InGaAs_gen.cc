...
class GSS_InGaAs_Avalanche : public PMIS_Avalanche
{
private:
  ...
  void 	Avalanche_Init()
  {
    N_IONIZA  =  0.000000E+00/cm;
    ECN_II    =  0.000000e+00*V/cm;
    EXN_II    =  0.000000E+00;
    P_IONIZA  =  0.000000E+00/cm;
    ...
    LAN300    =  1.000000E-06*cm;
    LAP300    =  1.000000E-06*cm;
    OP_PH_EN  =  1.000000E-02*eV;
...
public:    
  GSS_InGaAs_Avalanche(const PMIS_Environment &env):PMIS_Avalanche(env)
  {
    Avalanche_Init();
  }
  ~GSS_InGaAs_Avalanche()
  {
  }
...
extern "C"
{
  PMIS_Avalanche* PMIS_InGaAs_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_InGaAs_Avalanche(env);
  }
}
