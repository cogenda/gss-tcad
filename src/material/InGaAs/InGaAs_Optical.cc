...
// We do not have the real data for InGaAs, use parameters for GaAs instead
...
class GSS_InGaAs_Optical : public PMIS_Optical
{
private:
  int   table_size;
public:
...
// constructions
public:
  GSS_InGaAs_Optical(const PMIS_Environment &env):PMIS_Optical(env)
  {
...
extern "C"
{
  PMIS_Optical*  PMIS_InGaAs_Optical_Default (const PMIS_Environment& env)
  {
    return new GSS_InGaAs_Optical(env);
  }
}
