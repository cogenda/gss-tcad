...
class GSS_InGaAs_Thermal : public PMIS_Thermal
{
private:
  ...
  void   Thermal_Init()
  {
    ...
    A_TH_CON =  2.083000E-02*cm*K/J*s;
...
public:     
  GSS_InGaAs_Thermal(const PMIS_Environment &env):PMIS_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_InGaAs_Thermal()
...
extern "C"
{
  PMIS_Thermal* PMIS_InGaAs_Thermal_Default (const PMIS_Environment& env)
  {
    return new GSS_InGaAs_Thermal(env);
  }
}
