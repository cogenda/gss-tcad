...
private:
  ...
  {
    Ar_mumin_n	= 7.700e+04*cm*cm/V/s;  //Source: Semiconductors on NSM
    Ar_mumin_p	= 850*cm*cm/V/s;        //Source: Semiconductors on NSM
    Ar_alm_n  	= -1.6600e+00;          //Source: Semiconductors on NSM
    Ar_alm_p    = -1.8000e+00;          //Source: Semiconductors on NSM
    ...
    Ar_ala_p  	= 0.0000e+00;
    T300        = 300*K;
    E0N         = 4.0000e+03*V/cm;    //Source: data for InAs
    E0P         = 4.0000e+03*V/cm;    //Source: data for InAs
                                      //Source of vsat: Atlas user's guide
  }
...
public:
  ...
  {
    PetscScalar vsat = 1.0000e+06*cm/s;
...
extern "C"
{
  PMIS_Mobility* PMIS_InSb_Mob_Default (const PMIS_Environment& env)
  {
...
extern "C"
{
  PMIS_Mobility* PMIS_InSb_Mob_Analytic (const PMIS_Environment& env)
  {
    return new GSS_Mob_Analytic(env);
  }
}
