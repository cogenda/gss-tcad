...
class GSS_Elec_BasicParameter : public PMIC_BasicParameter
{
private:
...
public:
  ...
  GSS_Elec_BasicParameter(const PMIC_Environment &env):PMIC_BasicParameter(env)
  {
    Basic_Init();
  }
  ~GSS_Elec_BasicParameter()
  {
  }
}
;
...
extern "C"
{
  PMIC_BasicParameter* PMIC_Elec_BasicParameter_Default (const PMIC_Environment& env)
  {
    return new GSS_Elec_BasicParameter(env);
  }
}
