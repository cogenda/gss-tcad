...
public:
  ...
  {
    AutoDScalar vsat = 11.3E6*cm/s - 1.2E4*cm/s/K*Tl;
...
extern "C"
{
  PMIS_Mobility* PMIS_GaAs_Mob_Default (const PMIS_Environment& env)
  {
...
extern "C"
{
  PMIS_Mobility* PMIS_GaAs_Mob_Analytic (const PMIS_Environment& env)
  {
    return new GSS_Mob_Analytic(env);
  }
}
