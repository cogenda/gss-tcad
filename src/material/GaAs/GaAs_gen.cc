...
class GSS_GaAs_Avalanche : public PMIS_Avalanche
{
private:
...
public:    
  GSS_GaAs_Avalanche(const PMIS_Environment &env):PMIS_Avalanche(env)
  {
    Avalanche_Init();
  }
  ~GSS_GaAs_Avalanche()
...
extern "C"
{
  PMIS_Avalanche* PMIS_GaAs_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_GaAs_Avalanche(env);
  }
}
