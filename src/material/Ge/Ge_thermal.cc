...
class GSS_Ge_Thermal : public PMIS_Thermal
{
private:
  ...
  void   Thermal_Init()
  {
    ...
    A_TH_CON =  1.666700e+00*cm*K/J*s;
...
public:    
  GSS_Ge_Thermal(const PMIS_Environment &env):PMIS_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_Ge_Thermal()
...
extern "C"
{
  PMIS_Thermal* PMIS_Ge_Thermal_Default (const PMIS_Environment& env)
  {
    return new GSS_Ge_Thermal(env);
  }
}
