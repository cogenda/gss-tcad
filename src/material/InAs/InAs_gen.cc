...
class GSS_InAs_Avalanche : public PMIS_Avalanche
{
private:
...
public:  
  GSS_InAs_Avalanche(const PMIS_Environment &env):PMIS_Avalanche(env)
  {
    Avalanche_Init();
  }
  ~GSS_InAs_Avalanche()
...
extern "C"
{
  PMIS_Avalanche* PMIS_InAs_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_InAs_Avalanche(env);
  }
}
