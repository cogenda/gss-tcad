...
class GSS_SiGe_Avalanche_Default : public PMIS_Avalanche
{
private:
...
public:  
  //----------------------------------------------------------------
  GSS_SiGe_Avalanche_Default(const PMIS_Environment &env):PMIS_Avalanche(env)
  {
    Avalanche_Init();
  }
  ~GSS_SiGe_Avalanche_Default()
  {
  }
...
extern "C"
{
  PMIS_Avalanche* PMIS_SiGe_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_SiGe_Avalanche_Default(env);
  }
}
