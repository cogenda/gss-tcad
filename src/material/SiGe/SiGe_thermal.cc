...
class GSS_SiGe_Thermal : public PMIS_Thermal
{
private:
...
public:       
  GSS_SiGe_Thermal(const PMIS_Environment &env):PMIS_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_SiGe_Thermal()
...
extern "C"
{
  PMIS_Thermal* PMIS_SiGe_Thermal_Default (const PMIS_Environment& env)
  {
    return new GSS_SiGe_Thermal(env);
  }
}
