...
class GSS_Al_Optical : public PMIC_Optical
{
private:
  int   table_size;
public:
  ...
  // constructions
public:
  GSS_Al_Optical(const PMIC_Environment &env):PMIC_Optical(env)
  {
...
extern "C"
{
  PMIC_Optical*  PMIC_Al_Optical_Default (const PMIC_Environment& env)
  {
    return new GSS_Al_Optical(env);
  }
}
