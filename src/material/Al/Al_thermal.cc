...
class GSS_Al_Thermal : public PMIC_Thermal
{
private:
...
public:
  ...
  GSS_Al_Thermal(const PMIC_Environment &env):PMIC_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_Al_Thermal()
...
extern "C"
{
  PMIC_Thermal* PMIC_Al_Thermal_Default (const PMIC_Environment& env)
  {
    return new GSS_Al_Thermal(env);
  }
}
