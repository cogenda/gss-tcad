...
class GSS_Nitride_Thermal : public PMII_Thermal
{
private:
  ...
  void   Thermal_Init()
  {
    ...
    A_TH_CON =  5.405400E+00*cm*K/J*s;
...
public:
  ...
  GSS_Nitride_Thermal(const PMII_Environment &env):PMII_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_Nitride_Thermal()
...
extern "C"
{
  PMII_Thermal* PMII_Nitride_Thermal_Default (const PMII_Environment& env)
  {
    return new GSS_Nitride_Thermal(env);
  }
}
