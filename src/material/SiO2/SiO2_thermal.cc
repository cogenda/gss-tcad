...
class GSS_SiO2_Thermal : public PMII_Thermal
{
private:
...
public:
  ...
  GSS_SiO2_Thermal(const PMII_Environment &env):PMII_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_SiO2_Thermal()
...
extern "C"
{
  PMII_Thermal* PMII_SiO2_Thermal_Default (const PMII_Environment& env)
  {
    return new GSS_SiO2_Thermal(env);
  }
}
