...
class GSS_SiC3C_BandStructure : public PMIS_BandStructure
{
private:
  PetscScalar T300;
  //[Bandgap]
  ...
  void Eg_Init()
  {
    EG300     = 2.860000E+00*eV;
    EGALPH    = 4.730000E-04*eV/K;
    EGBETA    = 6.360000E+02*K;

    ELECMASS  = 0.35*me;
    HOLEMASS  = 0.72*me;
    NC300     = 1.230000E+19*pow(cm,-3);
    NV300     = 4.580000E+18*pow(cm,-3);
    NC_F      = 1.500000e+00;
    NV_F      = 1.500000e+00;
...
public:
  GSS_SiC3C_BandStructure(const PMIS_Environment &env):PMIS_BandStructure(env)
  {
    T300 = 300.0*K;
    Eg_Init();
    Lifetime_Init();
...
extern "C"
{
  PMIS_BandStructure*  PMIS_SiC3C_BandStructure_Default (const PMIS_Environment& env)
  {
    return new GSS_SiC3C_BandStructure(env);
  }
}
