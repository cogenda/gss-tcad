...
/*****************************************************************************/
//
// Material Type: 3C-SiC, use parameters for Si now.
...
extern "C"
{
  PMIS_Mobility* PMIS_SiC3C_Mob_Default (const PMIS_Environment& env)
  {
...
extern "C"
{
  PMIS_Mobility* PMIS_SiC3C_Mob_Analytic (const PMIS_Environment& env)
  {
    return new GSS_Mob_Analytic(env);
  }
}
