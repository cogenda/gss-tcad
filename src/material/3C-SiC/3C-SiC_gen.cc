...
class GSS_SiC3C_Avalanche_Default : public PMIS_Avalanche
{
private:
  ...
  void 	Avalanche_Init()
  {
    N_IONIZA  =  2.500000E+05/cm;
    ECN_II    =  0.000000E+00*V/cm;
    EXN_II    =  1.000000e+00;
    P_IONIZA  =  5.180000E+06/cm;
    ...
    LAN300    =  1.674250E-07*cm;
    LAP300    =  2.116730E-07*cm;
    OP_PH_EN  =  1.042000E-01*eV;
    //
    ElecTauw  = 2e-13*s;
    HoleTauw  = 2e-13*s;
    T300      = 300.0*K;
...
public:  
  ...
  GSS_SiC3C_Avalanche_Default(const PMIS_Environment &env):PMIS_Avalanche(env)
  {
    Avalanche_Init();
  }
  ~GSS_SiC3C_Avalanche_Default()
  {
  }
...
extern "C"
{
  PMIS_Avalanche* PMIS_SiC3C_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_SiC3C_Avalanche_Default(env);
  }
}
