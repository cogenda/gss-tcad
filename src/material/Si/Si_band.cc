...
private:
  ...
  void Eg_Init()
  {
    ...
    ELECMASS  = 1.0903*me;
    HOLEMASS  = 1.1525*me;
    NC300     = 2.86E19*pow(cm,-3);
    NV300     = 3.10E19*pow(cm,-3);
    NC_F      = 1.58;
    NV_F      = 1.85;
    N0_BGN    = 1.300000e+17*pow(cm,-3);
...
private:
  ...
  void Lifetime_Init()
  {
    ...
    SurfTauN  = 1.000000e+02*cm/s;
    SurfTauP  = 1.000000e+02*cm/s;
...
extern "C"
{
  PMIS_BandStructure*  PMIS_Si_BandStructure_Default (const PMIS_Environment& env)
  {
