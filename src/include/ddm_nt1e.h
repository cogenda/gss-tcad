...
class DDM_Solver_L1E : virtual public BSolver
{
private:
...
public:
  ...
  void           form_function_pn_1E(PetscScalar *,PetscScalar *);
  void           form_jacobian_pn_1E(PetscScalar *, Mat *,Mat *);
  void           error_norm_estimat(PetscScalar *,PetscScalar *);
  DDM_Solver_L1E():N(0),its(0),norm(0.0),mf_flg(PETSC_FALSE)  {}
};
